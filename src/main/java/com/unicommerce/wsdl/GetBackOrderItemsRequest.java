...
@XmlRootElement(name = "GetBackOrderItemsRequest")
public class GetBackOrderItemsRequest {

    @XmlElement(name = "SearchOptions", required = true)
    protected GetBackOrderItemsRequest.SearchOptions searchOptions;
     ...
     * @return
     *     possible object is
     *     {@link GetBackOrderItemsRequest.SearchOptions }
     *     
     */
    public GetBackOrderItemsRequest.SearchOptions getSearchOptions() {
     ...
     *     
     */
    public void setSearchOptions(GetBackOrderItemsRequest.SearchOptions value) {
